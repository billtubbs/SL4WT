...
%
% This script produces figures with plots of selected
% models using data originally generated by evaluate_models.m
% and used in the conference paper.
%
...
n_samples = 2:19;
n_figs = length(n_samples);
for i = 1:n_figs
    training_data{i} = array2table( ...
        data(1:n_samples(i), :), ...  % first n samples only
