...
%         gprMdlLP_machine1 = fitrgp(LOModelData.LoadMachine1,LOModelData.PowerMachine1, 'KernelFunction','ardsquaredexponential', 'KernelParameters',[15.0; 95.7708]);
...
%         gprMdlLP_machine2 = fitrgp(LOModelData.LoadMachine2,LOModelData.PowerMachine2, 'KernelFunction','squaredexponential', 'KernelParameters',[ 15.0; 111.0653]);
...
%         gprMdlLP_machine3 = fitrgp(LOModelData.LoadMachine3,LOModelData.PowerMachine3, 'KernelFunction','squaredexponential', 'KernelParameters',[15.5848; 153.5634]);
...
%         gprMdlLP_machine4 = fitrgp(LOModelData.LoadMachine4,LOModelData.PowerMachine4, 'KernelFunction','squaredexponential', 'KernelParameters', [15;280.8635]);
...
%     if min(abs(LOModelData.LoadMachine5-LOData.LoadMachine5(end,1)))>=4
       ...
       % gprMdlLP_machine5 = fitrgp(LOModelData.LoadMachine5,LOModelData.PowerMachine5, 'KernelFunction','squaredexponential', 'KernelParameters', [15.1001;236.1767]);
...
options = optimoptions('fmincon', "SubproblemAlgorithm","cg", 'MaxIterations',500000, "Display","iter");
