...
X = [0 200 400 600 800]';
params = config.machines.("machine_4").params;
[Y, X_actual] = sample_op_pts_poly(X, params);
...
X = [0 200 400 600 800]';
sigma_M = 1;
params = config.machines.("machine_5").params;
