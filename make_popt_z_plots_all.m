...
plot_dir = "plots";
filename = "sims_summary_all_combined.csv";
...
p = get(gcf, 'Position');
figsize = [n_plots*2+2.5 3];
set(gcf, 'Position', [p(1:2) figsize])
filename = sprintf("%s_popt_z_plot_%d.pdf", sim_name, n_plots);
